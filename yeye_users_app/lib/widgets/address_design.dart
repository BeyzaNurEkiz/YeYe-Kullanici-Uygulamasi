...
import 'package:yeye_users_app/mainScreens/placed_order_screen.dart';
      ...
      child: Card(
        ...
        child: Column(
          children: [
            ...
            //button
            ElevatedButton(
              child: const Text("Haritadan Bak"),
            ...
            widget.value == Provider.of<AddressChanger>(context).count
                ? ElevatedButton(
                  ...
                  onPressed: ()
                  {
                    Navigator.push(context, MaterialPageRoute(builder: (c)=> PlacedOrderScreen(addressID: widget.addressID,
                    totalAmount: widget.totalAmount,sellerUID: widget.sellerUID,
                    )
                    )
                    );
                  },
